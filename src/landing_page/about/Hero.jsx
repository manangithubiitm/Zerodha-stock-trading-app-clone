            ...
            <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8", fontSize:"1.2em"}}>
                <div className="col p-5">
                    <p>
                        ...
                        of breaking all the barriers that traders and investors face in India
                        in terms of cost, support, and technology. We named the company Zerodha,
                        a combination of Zero and "Rodha", the Sanskrit word for a barrier.
                    </p>
                    <p>
                ...
                <div className="col p-5">
                    ...
                    <p>
                        <a href="" className='link-style'>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups
