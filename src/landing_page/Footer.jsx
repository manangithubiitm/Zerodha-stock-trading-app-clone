      ...
      <div className="container border-top mt-3">
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            ...
            complaints pertaining to securitites broking please write to
          ...
          <p>
            ...
            intermediary(broker, DP, Mutual Fund etc.), you need not to undergo
            the same process again when you approach another intermediary." Dear
